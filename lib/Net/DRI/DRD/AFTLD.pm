## Domain Registry Interface, Afilias ccTLD policies
##
...
Net::DRI::DRD::AFTLD - Afilias ccTLD policies for Net::DRI
...
sub name     { return 'AFTLD'; }
sub tlds     { return ('hn', 'sc', 'vc', 'ag', 'bz', 'lc', 'mn'); }
